...
import RentalDetails from "../common/listing-details/RentalDetails";
...
const DetailsContent = ({rental}) => {
  return (
    <>
    {rental.description ? (
      <div className="listing_single_description">
        <div className="lsd_list">
          <PropertyItem property={rental} />
        </div>
        {/* End .lsd_list */}

        <h4 className="mb30">Description</h4>
        <PropertyDescriptions property={rental} />
      </div>
      ) : undefined}
      ...
      {Object.keys(rental.features).length > 0 ? (
        <div className="application_statics mt30">
          <div className="row">
            ...
            {/* End .col */}
            <PropertyFeatures features={rental.features} />
          </div>
        </div>
      ) : null}
      {/* End .feature_area */}
      ...
      <div className="application_statics mt30">
        <h4 className="mb30">
          Location <small className="float-end">{rental.address}</small>
        </h4>
