        ...
        <div className="container">
          <div className="common_div pre-approval">
            ...
            <p>
              ...
              provides a conditional commitment from the lender, stating the
              amount you can borrow and the terms you can expect.
            </p>
          </div>
          <div className="common_div find-property">
            ...
            <div className="my-4">
              ...
              <p className="p-0 ">
                Pre-approval streamlines the mortgage process, potentially
                leading to a faster closing once you find the right home.
              </p>
            </div>
            <div className="my-4">
              <h4
              ...
              <p className="p-0 ">
                It uncovers any potential issues with your credit or finances
                early in the process, allowing you to address them before making
                an offer on a home.
              </p>
            </div>
          </div>
